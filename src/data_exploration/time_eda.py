...
def plot_yearly_dist(output_dir, incidents_df): 
	...
	incidents_df['Call_Category'] = incidents_df['Subcall_Code'].apply(lambda x: call_category_map[x])
...
#### FIRE CALLS ####
'FFDM': 'fire', 'FFGR': 'fire', 'FFTE': 'fire', 'FFAA': 'fire', 'FFOE': 'fire', 'FFMA': 'fire',
'FFHV': 'fire', 'FFLB': 'fire', 'FFMB': 'fire', 'FFEL': 'fire', 'FFUN': 'fire', 'FFSC': 'fire',
'FFSB': 'fire', 'FFHU': 'fire', 'FFGL': 'fire', 'FFCM': 'fire', 'FCON': 'fire', 'FMSC': 'fire',
'FFAL': 'fire', 'FFWR': 'fire', 'FFNO': 'fire', 'FFOR': 'fire', 'FFLV': 'fire', 'FFCH': 'fire',
'FFGN': 'fire', 'FFHR': 'fire', 'FFSP': 'fire', 'FFWD': 'fire', 'FHPD': 'fire', 'FFCL': 'fire',
'FFAF': 'fire', 'FFVJ': 'fire', 'FFTS': 'fire', 'FFCS': 'fire', 'FFTR': 'fire', 'FSCK': 'fire',
'FFSS': 'fire', 'FFHA': 'fire', 'FFBS': 'fire', 'FF31': 'fire', 'FF21': 'fire', 'FFAB': 'fire',
'FFES': 'fire', 'FFFW': 'fire', 'FFSH': 'fire', 'FPCK': 'fire', 'FFFD': 'fire', 'FF51': 'fire',
'FME': 'fire', 'FPDA': 'fire', 'FFPR': 'fire', 'FFSE': 'fire', 'FFAR': 'fire', 'FFPI': 'fire',
'FFAC': 'fire', 'FF41': 'fire', 'FFWA': 'fire', 'FFCO': 'fire',
