...
def main():
    ...
    path_to_bg_data = path.join(data_dir, "American_Community_Survey_(ACS)_2017_Harris/Curated/2017/ACS20175Harris_BG_v01.csv")
    census_save_path = path.join(data_dir, "census_merged.csv")
    merge_by_bg(groupby_save_path, path_to_bg_data, "Block_Group", "GeoID17bg", census_save_path)
